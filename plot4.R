...
#top right
plot(as.numeric(pwrsub$Voltage) ~ pwrsub$days, type= "l",xlab="datetime", ylab=" Voltage")
...
legend("topright",
       ...
       lty = 1)
# Bottom right
plot(as.numeric(pwrsub$Global_reactive_power) ~ pwrsub$days, type= "l",xlab="datetime", ylab=" Global_Reactive_Power")
dev.off()
